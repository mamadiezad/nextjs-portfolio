      ...
      <section id="contact" className="py-24">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="https://t.me/llllxyz" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-card border border-border rounded-xl px-6 py-3 hover:border-primary/30 transition-all">
              <span className="text-xl">✈️</span><span>@llllxyz</span>
            </a>
          </div>
        </div>
      </section>
